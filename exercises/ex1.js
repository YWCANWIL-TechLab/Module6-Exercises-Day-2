 ...
 * 
 * @param {Array<Number>} numberArr 
 * @returns {Number} The difference between the array's max and min elements
 */
function findDifferenceBetweenMaxAndMin(numberArr) {
    // TODO Finish the function
}
 ...
 * 
 * @param {Array<Number>} numberArr 
 * @returns {Array<Number>} An array of squared numbers
 */
function squareEachElement(numberArr) {
    // TODO Finish the function
}
 ...
 * 
 * @param {Array<Number>} numberArr 
 * @returns {Number} The second smallest number
 */
function secondSmallestNumber(numberArr) {
    // TODO Finish the function
}
 ...
 * 
 * @param {Array<Number>} numberArr 
 * @returns {Array<Number>} An array of numbers greater than the avg of numberArr
 */
function greaterThanArrayAvg(numberArr) {
    // TODO Finish the function
}
